...
class Clock:
    ...
    def colorChange(self):
        #just cycle through numbers and pick color from list with that number
    ...
    def clock(self):
        ...
        #make UI elements, pack only am/pm, global time buttons.
    ...
    def time_style(self, hour_setting):
        ...
        #After selection is made, destroy old buttons and place/pack new UI
